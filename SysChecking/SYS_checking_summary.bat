...
REM	powershell "Test-NetConnection WINDC01.WIN.BETTING.HKJC.ORG.HK" >> %LogFile%
REM	powershell "Test-NetConnection WINDC02.WIN.BETTING.HKJC.ORG.HK" >> %LogFile%
REM	powershell "Test-NetConnection WINDC03.WIN.BETTING.HKJC.ORG.HK" >> %LogFile%
REM	powershell "Test-NetConnection WINDC04.WIN.BETTING.HKJC.ORG.HK" >> %LogFile%
